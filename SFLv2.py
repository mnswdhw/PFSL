...
def train_server(fx_client, y, l_epoch_count, l_epoch, idx, len_batch):
    ...
    if count1 == len_batch:
        ...
        if len(idx_collect) == num_users:
            ...
            acc_avg_all_user_train = sum(acc_train_collect_user)/len(acc_train_collect_user)  #only taking average of client 1-10
    ...
    with torch.no_grad():
        ...
        if count2 == len_batch:
            ...
            if fed_check:
                ...
                acc_avg_all_user = sum(acc_test_collect_user[1:])/len(acc_test_collect_user[1:])  #removing the 0th client from calculation of average
...
if __name__ == "__main__":
    ...
    # macs2, params2= profile(net_glob_client, inputs=(input, )) 
    # print("macs", "params", macs2, "::", params2)
    ...
    file_name = f"results/SFLv2/{program}_{args.batch_size}_{args.dataset}_{args.lr}_{args.epochs}_setting2"+".xlsx"    
